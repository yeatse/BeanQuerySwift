...
private struct FunctionRegistry {
    private let signatures: [FunctionSignature] = [
        FunctionSignature(name: "getitem", arguments: [.object, .string], result: .object),
        FunctionSignature(name: "getitem", arguments: [.object, .string, .object], result: .object),
        ...
        FunctionSignature(name: "round", arguments: [.decimal], result: .decimal),
        FunctionSignature(name: "round", arguments: [.decimal, .int], result: .decimal),
        FunctionSignature(name: "round", arguments: [.int], result: .int),
        FunctionSignature(name: "round", arguments: [.int, .int], result: .int),
        ...
        FunctionSignature(name: "safediv", arguments: [.decimal, .decimal], result: .decimal),
        FunctionSignature(name: "safediv", arguments: [.decimal, .int], result: .decimal),
        FunctionSignature(name: "safediv", arguments: [.int, .decimal], result: .decimal),
        FunctionSignature(name: "safediv", arguments: [.int, .int], result: .decimal),
        ...
        FunctionSignature(name: "length", arguments: [.string], result: .int),
        FunctionSignature(name: "length", arguments: [.list], result: .int),
        FunctionSignature(name: "repr", arguments: [.object], result: .string),
        FunctionSignature(name: "maxwidth", arguments: [.string, .int], result: .string),
        FunctionSignature(name: "substr", arguments: [.string, .int, .int], result: .string),
        FunctionSignature(name: "splitcomp", arguments: [.string, .string, .int], result: .string),
        ...
        FunctionSignature(name: "meta", arguments: [.string], result: .object),
        FunctionSignature(name: "entry_meta", arguments: [.string], result: .object),
        FunctionSignature(name: "any_meta", arguments: [.string], result: .object),
        FunctionSignature(name: "currency_meta", arguments: [.string], result: .object),
        FunctionSignature(name: "currency_meta", arguments: [.string, .string], result: .object),
        FunctionSignature(name: "commodity_meta", arguments: [.string], result: .object),
        FunctionSignature(name: "commodity_meta", arguments: [.string, .string], result: .object),
